...
class _DetailsState extends State<Details> {
  ...
  Future<void> getStadiumDetails(String id) async {
    ...
    setState(() {
      stadium = json.decode(response.body.toString());
    });
  }
      ...
      body: Stack(
        children: <Widget>[
          Container(
              ...
              height: 400,
              child: Image.network(
                  "https://resources.news.e.abb.com/images/2018/6/11/0/Luzhniki_Stadium1280X720.jpg",
                  fit: BoxFit.cover)),
                ...
                Row(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        "${stadium["stadium"][0]["rating"]}/5 reviews",
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Row(
                                  children: [
                                    RatingBarIndicator(
                                      rating: stadium['stadium'][0]['rating'],
